...
<div id="header-wrapper">
	<div id="header">
		<div id="logo">
			<h1><a href="#">GoodLife</a></h1>
		</div>
		<div id="menu">
			<ul>
				<li class="current_page_item"><a href="#" accesskey="1" title="">Homepage</a></li>
				<li><a href="#" accesskey="2" title="">Pessoas</a></li>
				<li><a href="#" accesskey="3" title="">Itens</a></li>
				<li><a href="#" accesskey="4" title="">Tipos</a></li>
				<li><a href="#" accesskey="5" title="">Contatos</a></li>
			</ul>
		</div>
	</div>
</div>
